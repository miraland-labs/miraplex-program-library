...
createErrorFromNameLookup.set(
  'InvalidClaimBump',
  () => new InvalidClaimBumpError()
)

/**
 * MustUseOfficialCandyMachine: 'Redrop only supports the official Metaplex Candy machine contracts'
 *
 * @category Errors
 * @category generated
 */
export class MustUseOfficialCandyMachineError extends Error {
  ...
  constructor() {
    super('Redrop only supports the official Metaplex Candy machine contracts')
    if (typeof Error.captureStackTrace === 'function') {
